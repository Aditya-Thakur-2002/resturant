...
if(isset($_POST['submit']))
{
		...
		{
			$sql=mysqli_query($con,"select * from register where id='".$_SESSION['userid']."' and password='".$_POST['oldpass']."'");
			if(!$sql)
			{
			...
			else
			{
				...
				{
					$sql=mysqli_query($con,"update register set password='".$_POST['newpass']."' where id='".$_SESSION['userid']."'");
					if(!$sql)
					{
						die(mysqli_error($con));
					}
